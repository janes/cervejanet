(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('cervejanetApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-cervejanetApp-error');
                var entityKey = httpResponse.headers('X-cervejanetApp-params');
                if (errorHeader) {
